/*
  # Correction RLS pour user_invitations - Admin seulement

  1. Fonction utilitaire
    - `is_admin()` pour vérifier si l'utilisateur connecté est admin
  ...
  3. Sécurité
    ...
    - Nouvelles politiques basées sur la fonction is_admin()
*/
...
-- Créer les nouvelles politiques strictes pour les admins seulement
